...
$(document.body).append(
        '<div id ="ddd1" style="z-index: 500;background-color:White;"  width="250" height="250">' +
        'hello world' +
...
$("img").bind("mouseout", function(){
        src = "";
        $(this).oneTime('2s', 'd2', function() { // 定时器
            if (onmouse == "") {// 如果公共变量为空，那么说明没有停留在图片上
                $("#ddd1").hide();
            }
        });
});
...
$("#ddd1").bind("mouseover", function() {
        onmouse="true";
});



$("#ddd1").bind("mouseout", function(){
        onmouse="";
        $("#ddd1").hide(); 
});
