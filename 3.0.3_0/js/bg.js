//Chrome璁㈠崟鍔╂墜閫昏緫锛�
//  0.鍒濆鍖栨椂棣栧厛灏唋ocalStorame[or.der.isSwitchOn]璁剧疆涓衡�渇alse鈥�
//  1.鍥犱负瀛樺湪涓や釜鐗堟湰锛寃ebStore涓婄殑3.0.0.1鍜屽畼缃戜笂鐨�0.1
//  2.灏唚ebStore涓婄殑鐗堟湰鏀逛负3.0.2锛岃繖鏃跺畼缃戝拰webStore涓婂畨瑁呯殑鎻掍欢灏嗚嚜鍔ㄥ崌绾�0.2
//  3.濡傛灉previousVersion涓�0.*寮�澶寸殑鍒欐墽琛屼笅闈㈢殑鍒ゆ柇锛屽惁鍒欏脊鍑哄埌updateLog
//  4.鍒ゆ柇localStorage閲岄潰鏄惁鏈塷rderConfigs锛屽鏋滄湁,澧炲姞璁㈠崟鍔╂墜璁剧疆鍒皀otification鐨勫乏涓嬭锛�
//    鐐瑰嚮鍒版彃浠惰缃〉闈€��
//
    ...
    if (currVersion != prevVersion) {
        ...
        if (typeof prevVersion === 'undefined') {
            ...
            if (!/3\.0\.?/.test(prevVersion)) {
                ...
                if (orderConfigs) {
                    //涓婁竴涓増鏈湁璁㈠崟鍔╂墜锛岃繖鏃堕渶瑕佸鍔犺缃寜閽�
...
/* 鍙戦�佹彃浠秇eartbeat锛屽繀椤绘斁鍒癱heckOptionStr()涔嬪墠 */
